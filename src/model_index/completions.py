...
CfcCompletion = namedtuple("CfcCompletion", "key content file_path accessor")
...
def make_completion(funct, cfc_file_path):
  ...
  return CfcCompletion(key_string, funct.name + "(" + make_arguments_string(funct.meta["arguments"]) + ")", cfc_file_path, funct.implicit)
