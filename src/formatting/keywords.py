    ...
    for r in keywords:
        ...
        if not cfml_format.view.match_selector(previous_char_point, 'comment'):
            ...
            if keyword in ['else', 'elseif', 'while', 'catch']:
                to_keyword_spacing = cfml_format.get_setting('keywords.block_to_keyword_spacing', keyword)
                ...
                to_keyword_spacing = cfml_format.get_setting('keywords.to_keyword_spacing', keyword)
        ...
        if cfml_format.view.match_selector(next_char_pt, GROUP_START_SELECTOR):
            has_group = True
            spacing_to_group = cfml_format.get_setting('keywords.spacing_to_group', keyword)
            ...
            empty_group_spacing = cfml_format.get_setting('keywords.empty_group_spacing', keyword)
            padding_inside_group = cfml_format.get_setting('keywords.padding_inside_group', keyword)
            padding_strip_newlines = cfml_format.get_setting('keywords.padding_strip_newlines', keyword, False)
...
def format_function_keywords(cfml_format):
    ...
    group_to_block_spacing = cfml_format.get_setting('function_declaration.group_to_block_spacing')
